...
namespace Source.Installers
{
    public class LevelInstaller : MonoInstaller
    {
        ...
        [SerializeField] private NewTurnGreeterView newTurnGreeterView;
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindInterfacesAndSelfTo<NewTurnGreeterView>().FromInstance(newTurnGreeterView).AsSingle();
